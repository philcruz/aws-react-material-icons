...
export default class Compute_AmazonVPC_VPNconnection extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AmazonVPC_VPNconnection.displayName = 'Compute_AmazonVPC_VPNconnection';
Compute_AmazonVPC_VPNconnection.muiName = 'Compute_AmazonVPC_VPNconnection';
