...
export default class Compute_AWSElasticBeanstalk_application extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AWSElasticBeanstalk_application.displayName = 'Compute_AWSElasticBeanstalk_application';
Compute_AWSElasticBeanstalk_application.muiName = 'Compute_AWSElasticBeanstalk_application';
