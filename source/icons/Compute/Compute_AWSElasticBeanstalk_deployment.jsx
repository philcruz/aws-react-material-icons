...
export default class Compute_AWSElasticBeanstalk_deployment extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AWSElasticBeanstalk_deployment.displayName = 'Compute_AWSElasticBeanstalk_deployment';
Compute_AWSElasticBeanstalk_deployment.muiName = 'Compute_AWSElasticBeanstalk_deployment';
