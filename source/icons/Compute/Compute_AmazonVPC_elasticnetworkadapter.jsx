...
export default class Compute_AmazonVPC_elasticnetworkadapter extends Component {
	constructor() {
		super();
	}
	render() {
		return (
			<SvgIcon {...this.props} >
				    <path d="M90,48.76l-26.5-24-12-12v12H32.62a9.12,9.12,0,0,0-9.12,9.12V68.62a9.12,9.12,0,0,0,9.12,9.12H51.5v12l12-12,13-13L90,51.24Z" fill="#9d5025"/>
    <path d="M76.5,35.26l-13-13-12-12v12H32.62a9.12,9.12,0,0,0-9.12,9.12V66.14a9.12,9.12,0,0,0,9.12,9.12H51.5v12l12-12,13-13L90,48.76Z" fill="#f58536"/>
...
Compute_AmazonVPC_elasticnetworkadapter.displayName = 'Compute_AmazonVPC_elasticnetworkadapter';
Compute_AmazonVPC_elasticnetworkadapter.muiName = 'Compute_AmazonVPC_elasticnetworkadapter';
