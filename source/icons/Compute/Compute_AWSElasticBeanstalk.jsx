...
export default class Compute_AWSElasticBeanstalk extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AWSElasticBeanstalk.displayName = 'Compute_AWSElasticBeanstalk';
Compute_AWSElasticBeanstalk.muiName = 'Compute_AWSElasticBeanstalk';
