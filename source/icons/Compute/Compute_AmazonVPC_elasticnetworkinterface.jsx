...
export default class Compute_AmazonVPC_elasticnetworkinterface extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AmazonVPC_elasticnetworkinterface.displayName = 'Compute_AmazonVPC_elasticnetworkinterface';
Compute_AmazonVPC_elasticnetworkinterface.muiName = 'Compute_AmazonVPC_elasticnetworkinterface';
