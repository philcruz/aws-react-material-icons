...
export default class Compute_AmazonLightsail extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AmazonLightsail.displayName = "Compute_AmazonLightsail";
Compute_AmazonLightsail.muiName = "Compute_AmazonLightsail";
