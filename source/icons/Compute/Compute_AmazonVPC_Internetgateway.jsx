...
export default class Compute_AmazonVPC_Internetgateway extends Component {
	constructor() {
		super();
	}
	render() {
...
Compute_AmazonVPC_Internetgateway.displayName = 'Compute_AmazonVPC_Internetgateway';
Compute_AmazonVPC_Internetgateway.muiName = 'Compute_AmazonVPC_Internetgateway';
